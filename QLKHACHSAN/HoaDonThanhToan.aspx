<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HoaDonThanhToan.aspx.cs" Inherits="QLKHACHSAN.HoaDonThanhToan" %>
...
<body>
    <form id="form1" runat="server">
        <div class="tieude">
            ...
            <h2>Danh Sách Phiếu Phòng Và Dịch Vụ</h2>
        </div>
        <div class="tieude">
        ...
        <asp:GridView CssClass="bang2" ID="grid_dichvu" runat="server" AutoGenerateColumns="False">
            <Columns>
                ...
                <asp:BoundField DataField="GiaDV" HeaderText="Giá Dịch Vụ" SortExpression="GiaDV" />
                <asp:BoundField DataField="ThanhTien" HeaderText="Thành Tiền" SortExpression="ThanhTien" />
                <asp:TemplateField HeaderText="Xóa Phiếu">
                    <ItemTemplate>
